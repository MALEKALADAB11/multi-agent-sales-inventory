...
async def coach_chat(request: Request, body: dict):
    ...
    try:
        from auth_router import validate_store_access as _vsa
    ...
    try:
        ...
        if _candidate_products:
            from modules.coaching.agents.coach.cross_domain_tools import rank_products
...
async def coach_chat_stream(request: Request, body: dict):
    ...
    async def _sse_gen():
        ...
        try:
            from modules.coaching.agents.guardrail.guardrail_agent import evaluate_guardrails as _eval_g
            _snap_s = {
                "skus": {
                    a["nom"]: {
                        "product_name":   a["nom"],

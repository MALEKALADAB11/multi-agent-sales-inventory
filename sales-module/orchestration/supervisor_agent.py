...
async def node_inventory_branch(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        inv_path = os.path.join(
            os.path.dirname(__file__), "..", "..", "..", "inventory-module"
        )
...
async def node_coach_agent(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        from modules.coaching.agents.coach.cross_domain_tools import (
            get_sales_context,
...
async def node_guardrail(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        from modules.coaching.agents.guardrail.guardrail_agent import guardrail_node
...
def build_supervisor_graph():
    ...
    from core.retail_state import RetailState
